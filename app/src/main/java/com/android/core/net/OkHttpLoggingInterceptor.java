...
public class OkHttpLoggingInterceptor implements Interceptor {
    ...
    public OkHttpLoggingInterceptor(HttpLoggingInterceptor.Logger logger) {
        this.logger = logger;
    }
    ...
    public OkHttpLoggingInterceptor setLevel(HttpLoggingInterceptor.Level level) {
